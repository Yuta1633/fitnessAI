...
const MEAL_DB = [
  ...
  // 全目的 × 食べる時間があまりない
  { id:'g1t01', name:'おにぎり1個＋サラダチキン', ingredients:['おにぎり 1個（鮭）', 'サラダチキン 1個'], cal:295, p:28, f:2, c:40, goals:['1'], locations:['食べる時間があまりない'] },
  { id:'g1t02', name:'ゆで卵2個＋野菜ジュース', ingredients:['ゆで卵 2個', '野菜ジュース 200ml'], cal:210, p:14, f:12, c:12, goals:['1'], locations:['食べる時間があまりない'] },
  { id:'g1t03', name:'サラダチキンバー＋おにぎり', ingredients:['サラダチキン 80g', 'おにぎり 1個'], cal:260, p:22, f:2, c:38, goals:['1'], locations:['食べる時間があまりない'] },

  { id:'g2t01', name:'おにぎり2個＋ゆで卵2個＋牛乳', ingredients:['おにぎり 2個', 'ゆで卵 2個', '牛乳 200ml'], cal:580, p:30, f:16, c:72, goals:['2'], locations:['食べる時間があまりない'] },
  { id:'g2t02', name:'サラダチキン2個＋おにぎり2個', ingredients:['サラダチキン 2個', 'おにぎり 2個'], cal:590, p:54, f:4, c:76, goals:['2'], locations:['食べる時間があまりない'] },
  { id:'g2t03', name:'プロテインバー2本＋バナナ＋牛乳', ingredients:['プロテインバー 2本', 'バナナ 1本', '牛乳 200ml'], cal:560, p:38, f:14, c:70, goals:['2'], locations:['食べる時間があまりない'] },

  { id:'g3t01', name:'バナナ2本＋おにぎり1個', ingredients:['バナナ 2本', 'おにぎり 1個'], cal:380, p:8, f:2, c:82, goals:['3'], locations:['食べる時間があまりない'] },
  { id:'g3t02', name:'カロリーメイト＋牛乳', ingredients:['カロリーメイト 2本', '牛乳 200ml'], cal:360, p:12, f:14, c:44, goals:['3'], locations:['食べる時間があまりない'] },
  { id:'g3t03', name:'おにぎり2個＋野菜ジュース', ingredients:['おにぎり 2個', '野菜ジュース 200ml'], cal:400, p:10, f:2, c:82, goals:['3'], locations:['食べる時間があまりない'] },

  { id:'g4t01', name:'おかゆ（レトルト）＋ゆで卵', ingredients:['おかゆ レトルト 1個', 'ゆで卵 1個'], cal:220, p:10, f:6, c:30, goals:['4'], locations:['食べる時間があまりない'] },
  { id:'g4t02', name:'豆乳＋バナナ＋ヨーグルト', ingredients:['豆乳 200ml', 'バナナ 1本', 'ヨーグルト 100g'], cal:280, p:12, f:4, c:48, goals:['4'], locations:['食べる時間があまりない'] },
  { id:'g4t03', name:'野菜スープ＋おにぎり', ingredients:['野菜スープ 1杯', 'おにぎり 1個'], cal:260, p:6, f:2, c:50, goals:['4'], locations:['食べる時間があまりない'] },

  { id:'g5t01', name:'サラダチキン＋ゆで卵＋野菜スティック', ingredients:['サラダチキン 1個', 'ゆで卵 1個', '野菜スティック 100g'], cal:220, p:30, f:6, c:8, goals:['5'], locations:['食べる時間があまりない'] },
  { id:'g5t02', name:'ギリシャヨーグルト＋おにぎり1個', ingredients:['ギリシャヨーグルト 100g', 'おにぎり 1個（梅）'], cal:240, p:14, f:2, c:42, goals:['5'], locations:['食べる時間があまりない'] },
  { id:'g5t03', name:'豆乳＋サラダチキンバー', ingredients:['豆乳 200ml', 'サラダチキン 80g'], cal:200, p:22, f:4, c:16, goals:['5'], locations:['食べる時間があまりない'] },

  // 全目的 × 節約したい
  { id:'g1z01', name:'卵かけご飯＋もやし炒め＋味噌汁', ingredients:['卵 1個', '白米 120g', 'もやし 100g（炒め）', '味噌汁 1杯'], cal:360, p:18, f:10, c:48, goals:['1'], locations:['節約したい'] },
  { id:'g1z02', name:'納豆ご飯＋豆腐の味噌汁', ingredients:['納豆 1パック', '白米 120g', '豆腐の味噌汁 1杯'], cal:370, p:20, f:8, c:52, goals:['1'], locations:['節約したい'] },
  { id:'g1z03', name:'ツナ缶＋白米＋ほうれん草', ingredients:['ツナ缶 1缶', '白米 120g', 'ほうれん草 80g（茹でる）'], cal:340, p:24, f:4, c:50, goals:['1'], locations:['節約したい'] },

  { id:'g2z01', name:'卵4個炒め＋白米大盛＋味噌汁', ingredients:['卵 4個（炒り卵）', '白米 200g', '味噌汁 1杯'], cal:640, p:34, f:22, c:74, goals:['2'], locations:['節約したい'] },
  { id:'g2z02', name:'鶏むね肉＋白米大盛＋もやし', ingredients:['鶏胸肉 200g（茹でる）', '白米 200g', 'もやし 100g'], cal:580, p:46, f:6, c:76, goals:['2'], locations:['節約したい'] },
  { id:'g2z03', name:'サバ缶＋白米大盛＋卵＋味噌汁', ingredients:['サバ缶 1缶', '白米 200g', '卵 1個', '味噌汁 1杯'], cal:620, p:42, f:18, c:68, goals:['2'], locations:['節約したい'] },

  { id:'g3z01', name:'うどん＋卵＋ねぎ＋天かす少量', ingredients:['うどん 1玉', '卵 1個', 'ねぎ 20g', '天かす 10g'], cal:380, p:16, f:8, c:60, goals:['3'], locations:['節約したい'] },
  { id:'g3z02', name:'白米＋納豆＋卵＋もやし炒め', ingredients:['白米 150g', '納豆 1パック', '卵 1個', 'もやし 100g'], cal:420, p:22, f:10, c:58, goals:['3'], locations:['節約したい'] },
  { id:'g3z03', name:'パスタ（オイル系）＋卵', ingredients:['パスタ 1人前', 'オリーブオイル 大さじ1', '卵 1個', 'にんにく'], cal:480, p:18, f:14, c:68, goals:['3'], locations:['節約したい'] },

  { id:'g4z01', name:'おかゆ＋納豆＋味噌汁', ingredients:['白米 100g（おかゆ）', '納豆 1パック', '味噌汁 1杯'], cal:290, p:14, f:6, c:44, goals:['4'], locations:['節約したい'] },
  { id:'g4z02', name:'豆腐＋卵＋白米＋わかめスープ', ingredients:['豆腐 150g', '卵 1個', '白米 120g', 'わかめスープ 1杯'], cal:360, p:22, f:10, c:46, goals:['4'], locations:['節約したい'] },
  { id:'g4z03', name:'ツナ缶＋豆腐＋白米＋味噌汁', ingredients:['ツナ缶 1缶', '豆腐 100g', '白米 120g', '味噌汁 1杯'], cal:340, p:24, f:6, c:46, goals:['4'], locations:['節約したい'] },

  { id:'g5z01', name:'鶏むね肉＋白米少なめ＋もやし炒め', ingredients:['鶏胸肉 150g（茹でる）', '白米 100g', 'もやし 100g（炒め）'], cal:320, p:36, f:4, c:36, goals:['5'], locations:['節約したい'] },
  { id:'g5z02', name:'卵2個＋豆腐＋白米少なめ＋味噌汁', ingredients:['卵 2個', '豆腐 150g', '白米 100g', '味噌汁 1杯'], cal:380, p:26, f:12, c:42, goals:['5'], locations:['節約したい'] },
  { id:'g5z03', name:'ツナ缶＋白米少なめ＋サラダ＋卵', ingredients:['ツナ缶 1缶', '白米 100g', 'サラダ 1皿', '卵 1個'], cal:340, p:26, f:8, c:38, goals:['5'], locations:['節約したい'] }
];
